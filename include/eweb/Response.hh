...
struct Response {
  ...
  static inline asio::const_buffer response_code_to_buf(Response::ResponseCode response_code) {
  ...
  static inline asio::const_buffer header_sep() {
    static const std::string val = ": ";
    return asio::buffer(val);
  }

  static inline asio::const_buffer endline() {
    static const std::string val = "\r\n";
    return asio::buffer(val);
  }
